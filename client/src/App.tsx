...
console.log("clusters updated",clusters);
  ...
  return (
    ...
    <div style={{width:'100vw',height:'100px',marginTop:'-20px',backgroundColor:'rgba(0,100,100,0.5)',display:'flex',justifyContent:'center',alignItems:'center'}}>
      ...
      <div style={{width:'100vw', height:'200px', backgroundColor:'rgba(127, 150, 151, 0.14)',borderTop:'5px solid black',display:'flex',justifyContent:'center',alignItems:'center'}}>
        <div style={{display:'flex',justifyContent:'center',alignItems:'center'}}>
        <p style={{marginLeft:'5px',marginRight:'20px', fontSize:'20px',fontWeight:'bold'}}>BathHack2024</p>
